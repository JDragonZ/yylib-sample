...
var YYTransfer = _require.YYTransfer;
...
var YYApproveUser = function (_React$Component) {
	...
	function YYApproveUser(props) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(YYApproveUser).call(this, props));
	...
	_createClass(YYApproveUser, [{
		...
		value: function render() {
			...
			var activeKey = _state2.activeKey;
				...
				_react2.default.createElement(
					...
					{ ref: 'modal',
						...
						footer: [_react2.default.createElement(
							...
							YYButton,
							{ key: 'submit', type: 'primary', onClick: this.comfirm },
							'提 交'
						)] },
					_react2.default.createElement(
						_antd.Tabs,
