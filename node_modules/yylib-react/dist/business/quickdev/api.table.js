...
ApiTable.init = function () {
    var options = arguments.length <= 0 || arguments[0] === undefined ? { page: null, table: null } : arguments[0];
...
ApiTable.loadData = function () {
    var options = arguments.length <= 0 || arguments[0] === undefined ? { page: null, table: null, params: null } : arguments[0];
    ...
    var _params = {};
    //_params.sort = [];
    var baseUrl = 'http://60.205.12.0:81/icop-front-web';
