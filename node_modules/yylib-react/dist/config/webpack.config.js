...
module.exports = {
    ...
    , getDefaultPlugins: function getDefaultPlugins(options) {
        ...
        plugins.push(new webpack.optimize.CommonsChunkPlugin({
            names: ['yylibui', 'lodash', 'antd', 'common'], //注意：最后的一个文件，在html中必须第一个加载
    ...
    , getDefaultLoaders: function getDefaultLoaders(options) {
        ...
        { test: /\.js?$/, exclude: /node_modules/, loaders: ['react-hot-loader/webpack', 'babel?compact=false,presets[]=react,presets[]=es2015'] }, { test: /\.css$/, loader: ExtractTextPlugin.extract("style-loader", "css-loader") }, //"style-loader!css-loader"
        { test: /\.less$/, loader: ExtractTextPlugin.extract("style-loader", "css-loader!less-loader") }, { test: /\.json$/, loader: 'json-loader' },
        // {test: /\.(png|jpg)$/, loader: 'url-loader?limit=8192'}, // inline base64 URLs for <=8k images, direct URLs for the rest
        { test: /\.(png|jpg|gif)$/, loader: 'file-loader?name=' + imageFileName }, { test: /\.(ttf\??|eot\??|svg\??|woff\??|woff2\??)/, loader: "file-loader?name=" + fontFileName }];
        return loaders;
    }
    //默认别名集合
    , getDefaultAlias: function getDefaultAlias(alias, nodeModulesPath) {
        var _defaultAlias = Object.assign({
            ...
            //,"antd.css":path.join(nodeModulesPath,'/antd/dist/antd.min.css')
            //demos工程下使用此路径
            //,"yylib-ui": path.join(cwd,'./core/yylib2')//新UI库
            //,"yylib-utils": path.join(cwd,'./core/utils')//工具库
            //,"yylib-business": path.join(cwd,'./core/business')//业务组件库
            //,"yylib-trd": path.join(cwd,'./trd')//第三方库
            //应用工程下使用此路径
    ...
    , webpackdll: function webpackdll(options) {
        ...
        return {
            ...
            plugins: options.plugins || [new webpack.DefinePlugin({ 'process.env.NODE_ENV': '"production"' }), new webpack.DllPlugin({
