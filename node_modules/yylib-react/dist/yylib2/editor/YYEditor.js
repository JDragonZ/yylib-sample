...
var uiMeta = {
    ...
    //field('focusEditor','',PropTypes.oneOf(['click','hover']),false,'focus the editor')
    field('defaultValue', '', PropTypes.string, false, '编辑器默认显示的内容'), field('value', '', PropTypes.string, false, '编辑器显示的内容值'), field('icons', undefined, PropTypes.any, false, '配置工具栏的图标启用状态'), field('uploadImgUrl', undefined, PropTypes.string, false, '上传图片服务的URL地址'), field('uploadImgName', undefined, PropTypes.string, false, '上传图片服务的文件标识名'), field('plugins', {}, PropTypes.object, false, '配置第三方的插件'), field('enablePasteUpload', true, PropTypes.bool, false, '是否启用粘贴上传图片')]
};
...
var YYEditor = YYClass.create({
    ...
    _getIcons: function _getIcons() {
        ...
        var resultIcons = [];
        var settingIcons = { source: false, superscript: false, subscript: false, insertorderedlist: false, insertunorderedlist: false };
        if (_.isArray(icons)) {
            //覆盖工具栏
            defaultIcons = icons;
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(Editor, _extends({}, this.props, { ref: 'yyEditor', plugins: this._getPlugins(), icons: this._getIcons() }))
        );
    }
});
