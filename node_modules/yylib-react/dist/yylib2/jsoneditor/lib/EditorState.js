...
var EditorState = function () {
  function EditorState(json) {
    ...
    this.state = Immutable.fromJS(this.parseJson(json));
    this.dirty = false;
    this.undoStack = [];
    this.redoStack = [];
  }
  ...
  _createClass(EditorState, [{
    ...
    value: function addArrayElement(path, value) {
      ...
      if (Immutable.List.isList(currentValue)) {
    ...
    value: function getValueAt(path, asJson) {
      ...
      if (Immutable.Iterable.isIterable(value) && asJson) {
        return value.toJSON();
      }
    ...
    value: function setFieldValue(path, value) {
      ...
      this.state = this.state.setIn(path, Immutable.fromJS(value));
