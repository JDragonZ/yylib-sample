...
var YYJsonTextarea = YYClass.create({
    ...
    render: function render() {
        return JSONEditor ? React.createElement('div', { className: this.className() }) : React.createElement(
            'div',
            null,
            React.createElement(
                'p',
                null,
                '请在index.html中引入以下两行代码：'
            ),
            React.createElement(
                'p',
                null,
                '<link href="http://cdn.bootcss.com/jsoneditor/5.5.10/jsoneditor.min.css" rel="stylesheet" />'
            ),
            React.createElement(
                'p',
                null,
                '<script src="http://cdn.bootcss.com/jsoneditor/5.5.10/jsoneditor.min.js"></script>'
            )
        );
    }
});
