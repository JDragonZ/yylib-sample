...
var uiMeta = {
    ...
    field('type', '', PropTypes.string, true, '设置图标类型'), field('title', '', PropTypes.string, false, '鼠标浮上后的提示'), field('size', null, PropTypes.number, false, '字体图标显示大小'), field('fontClass', null, PropTypes.number, false, '使用自定义字体图标样式,当使用此属性时type属性将失效')]
};
var YYIcon = YYClass.create({
    ...
    render: function render() {
        ...
        var fontClass = _props.fontClass;
