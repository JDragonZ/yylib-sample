...
exports.OrgNodeV2 = OrgNodeV2;
exports.OrgChartV2 = OrgChartV2;
...
OrgNodeV2.prototype = {
    ...
    ctor: function ctor(userNodeParams) {
        var ret = false;

        if ((typeof userNodeParams === "undefined" ? "undefined" : _typeof(userNodeParams)) === "object" && userNodeParams !== null) {

            if (_typeof(userNodeParams.options) === "object" && userNodeParams.options !== null) {

                this.options = this.getDiffParams(this.options, userNodeParams.options);
            }

            if (_typeof(userNodeParams.event) === "object" && userNodeParams.event !== null) {

                this.event = this.getDiffParams(this.event, userNodeParams.event);
            }

            if (_typeof(userNodeParams.customParams) === "object" && userNodeParams.customParams !== null) {
    ...
    render: function render(globChart, globParams, globEvent) {
        var ret = {
            offsetWidth: 0,
            offsetHeight: 0,
            isInit: false
        ...
        if ((typeof globChart === "undefined" ? "undefined" : _typeof(globChart)) === "object" && globChart !== null) {
            // TODO
        }

        if ((typeof globParams === "undefined" ? "undefined" : _typeof(globParams)) === "object" && globParams !== null) {
            ...
            this.options.minWidth = this.options.minWidth <= 0 || this.options.minWidth > globParams.node.minWidth ? globParams.node.minWidth : this.options.minWidth;
            this.options.minHeight = this.options.minHeight <= 0 || this.options.minHeight > globParams.node.minHeight ? globParams.node.minHeight : this.options.minHeight;
        ...
        if ((typeof globEvent === "undefined" ? "undefined" : _typeof(globEvent)) === "object" && globEvent !== null && _typeof(globEvent.node) === "object" && globEvent.node !== null) {
        ...
        if (_typeof(this.customParams) === "object" && this.customParams !== null) {
        ...
        if (_typeof(docTempDiv.firstChild) === "object" && typeof docTempDiv.firstChild !== null) {
        ...
        if ((typeof docRootElement === "undefined" ? "undefined" : _typeof(docRootElement)) == "object" && docRootElement !== null) {
        ...
        if (_typeof(this.node.instance) === "object" && this.node.instance !== null) {
    ...
    add: {
        nodes: function nodes(orgChildNode) {
            return OrgNodeV2.prototype.addNodes(orgChildNode);
        }
    },
    addNodes: function addNodes(orgChildNode) {
        var ret = false;

        if ((typeof orgChildNode === "undefined" ? "undefined" : _typeof(orgChildNode)) === "object" && orgChildNode !== null && _typeof(orgChildNode.node) === "object" && orgChildNode.node !== null) {
    ...
    get: {
        ...
        offset: function offset(sender) {
            return OrgNodeV2.prototype.getOffset();
        },
        uniqueID: function uniqueID(length, prefix, index) {
            return OrgNodeV2.prototype.getUniqueID();
        },
        diffParams: function diffParams(sourceParams, mappingParams) {
    ...
    getOffset: function getOffset(sender) {
        var ret = {
            x: 0,
            y: 0,
            width: 0,
        ...
        if ((typeof sender === "undefined" ? "undefined" : _typeof(sender)) === "object" && sender !== null) {
            ...
            if (_typeof(sender.currentStyle) === "object" && sender.currentStyle !== null) {
    ...
    getUniqueID: function getUniqueID(length, prefix, index) {
        var ret = "";
    ...
    getDiffParams: function getDiffParams(sourceParams, mappingParams) {
        var ret = sourceParams;

        if ((typeof sourceParams === "undefined" ? "undefined" : _typeof(sourceParams)) === "object" && sourceParams !== null && (typeof mappingParams === "undefined" ? "undefined" : _typeof(mappingParams)) === "object" && mappingParams !== null) {
            ...
            for (var k in mappingParams) {
                ...
                if (typeof mappingParams[k] === "number" || typeof mappingParams[k] === "boolean" || typeof mappingParams[k] === "string" || typeof mappingParams[k] === "function") {
...
OrgChartV2.prototype = {
    ...
    ctor: function ctor(userChartParams) {
        var ret = false;

        if ((typeof userChartParams === "undefined" ? "undefined" : _typeof(userChartParams)) === "object" && userChartParams !== null && _typeof(userChartParams.nodes) === "object" && userChartParams.nodes !== null) {

            if (typeof userChartParams.nodes.getDiffParams === "function") {
                this.nodes = userChartParams.nodes;

                if (_typeof(userChartParams.options) === "object" && userChartParams.options !== null) {

                    this.options = this.nodes.getDiffParams(this.options, userChartParams.options);
                }

                if (_typeof(userChartParams.event) === "object" && userChartParams.event !== null) {
    ...
    render: function render() {
        ...
        if (_typeof(this.nodes) !== "object" || this.nodes === null || _typeof(this.nodes.nodes) !== "object" || typeof this.nodes.nodes === null
        ...
        if (_typeof(this.options) === "object" && this.options !== null) {
        ...
        for (var i = 0; i < nodesLength; i++) {
            ...
            if (_typeof(this.nodesDepths[i].node.instance) === "object" && this.nodesDepths[i].node.instance !== null) {
        ...
        if (this.options.expandTarget == true) {
            if ((typeof parentDOM === "undefined" ? "undefined" : _typeof(parentDOM)) === "object" && parentDOM !== null) {
    ...
    set: {
        depth: function depth(orgNodes) {
            return OrgChartV2.prototype.setDepth(orgNodes);
        },
        depthWidth: function depthWidth() {},
        depthGroupsWidth: function depthGroupsWidth() {
            return OrgChartV2.prototype.setDepthGroupsWidth();
        },
        depthHeight: function depthHeight() {
            return OrgChartV2.prototype.setDepthHeight();
        },
        nodeLeft: function nodeLeft(depthNodes, nodeID, tagID) {
            return OrgChartV2.prototype.setNodeLeft(depthNodes, nodeID, tagID);
        },
        nodeLeftAmend: function nodeLeftAmend(orgNode, errDistance) {
            return OrgChartV2.prototype.setNodeLeftAmend(orgNode, errDistance);
        }
    },
    setDepth: function setDepth(orgNodes) {
        if ((typeof orgNodes === "undefined" ? "undefined" : _typeof(orgNodes)) === "object" && orgNodes !== null && _typeof(orgNodes.node) === "object" && orgNodes.node !== null) {
            ...
            if (_typeof(this.depthGroup[orgNodes.node.depth]) !== "object") {
            ...
            if (orgNodes.node.depth == 1) {
                ...
                if (this.depthGroup[orgNodes.node.depth].nodeGroups.length == 0) {
                    ...
                    if (orgNodes.node.parent == this.depthGroup[orgNodes.node.depth].nodeGroups[groupsLength - 1][groupNodesLength - 1].node.parent) {
                        ...
                        if (_typeof(this.depthGroup[orgNodes.node.depth].nodeGroups[groupsLength]) !== "object") {
    ...
    setDepthWidth: function setDepthWidth() {},
    setDepthGroupsWidth: function setDepthGroupsWidth() {
        for (var i = 1; i <= this.chart.depth; i++) {
            if (_typeof(this.depthGroup[i]) !== "object" || this.depthGroup[i] === null || _typeof(this.depthGroup[i].nodeGroups) !== "object" || this.depthGroup[i].nodeGroups === null) {
    ...
    setDepthHeight: function setDepthHeight() {
        for (var i = 1; i <= this.chart.depth; i++) {
            if (_typeof(this.depthGroup[i]) !== "object" || this.depthGroup[i] === null || _typeof(this.depthGroup[i].nodes) !== "object" || this.depthGroup[i].nodes === null) {
    ...
    setNodeLeft: function setNodeLeft(depthNodes, nodeID, tagID) {
        var ret = false;
    ...
    setNodeLeftAmend: function setNodeLeftAmend(orgNode, errDistance) {
    ...
    get: {
        ...
        elementParents: function elementParents(element) {
            return OrgChartV2.prototype.getElementParents(element);
        },
        elementOffsetParents: function elementOffsetParents(element) {
            return OrgChartV2.prototype.getElementOffsetParents(element);
        },
        elementOffsetPosition: function elementOffsetPosition(element) {
            return OrgChartV2.prototype.getElementOffsetPosition(element);
        },
        firstLeftPosition: function firstLeftPosition(orgNode) {
            return OrgChartV2.prototype.getFirstLeftPosition(orgNode);
        },
        nodesWidth: function nodesWidth(orgNodes) {
            return OrgChartV2.prototype.getNodesWidth(orgNodes);
        },
        nodesDepth: function nodesDepth(orgNodes) {
            return OrgChartV2.prototype.getNodesDepth(orgNodes);
        },
        groupWidth: function groupWidth(orgNode) {
            return OrgChartV2.prototype.getGroupWidth(orgNode);
        },
        depthHeightToRoot: function depthHeightToRoot(depthID) {
    ...
    getElementParents: function getElementParents(element) {
        var ret = [];

        element = typeof element === "string" ? document.getElementById(element) : element;

        if ((typeof element === "undefined" ? "undefined" : _typeof(element)) === "object" && element !== null && element.nodeName !== null && element.parentNode !== null) {
    ...
    getElementOffsetParents: function getElementOffsetParents(element) {
        var ret = {
            elements: [],
            offsetLeft: 0,
            offsetTop: 0
    ...
    getElementOffsetPosition: function getElementOffsetPosition(element) {
        var ret = {
            offsetLeft: 0,
            offsetTop: 0
        };
        ...
        if ((typeof element === "undefined" ? "undefined" : _typeof(element)) === "object" && element !== null && isNaN(element.offsetLeft) === false && element.offsetLeft !== null && isNaN(element.offsetTop) === false && element.offsetTop !== null) {
    ...
    getFirstLeftPosition: function getFirstLeftPosition(orgNode) {
        var ret = 0;

        if ((typeof orgNode === "undefined" ? "undefined" : _typeof(orgNode)) === "object" && orgNode !== null) {
            ...
            if (isNaN(orgNode.node.orderID) === true || orgNode.node.orderID == 0) {
                ...
                for (var i = 0; i <= orgNode.node.orderID; i++) {
                    ...
                    if (_typeof(this.depthGroup[nodeDepth]) !== "object" || this.depthGroup[nodeDepth] === null) {
    ...
    getNodesWidth: function getNodesWidth(orgNodes) {
        var ret = 0;

        if ((typeof orgNodes === "undefined" ? "undefined" : _typeof(orgNodes)) === "object" && orgNodes !== null) {
            ...
            for (var i = 0; i < orgNodes.nodes.length; i++) {
                ...
                var optMinWidth = isNaN(orgNodes.nodes[i].options.minWidth) === false && orgNodes.nodes[i].options.minWidth !== null ? orgNodes.nodes[i].options.minWidth : 0;
    ...
    getNodesDepth: function getNodesDepth(orgNodes) {},
    getGroupWidth: function getGroupWidth(orgNode) {
        var ret = 0;
    ...
    getDepthHeightToRoot: function getDepthHeightToRoot(depthID) {
        var ret = 0;
        var i = isNaN(depthID) === false && depthID !== null ? depthID : 0;

        for (i; i >= 1; i--) {
            if (_typeof(this.depthGroup[i]) !== "object" || this.depthGroup[i] === null) {
        ...
        if (_typeof(this.depthGroup[depthID]) === "object" && this.depthGroup[depthID] !== null) {
    ...
    draw: {
        nodesInit: function nodesInit(orgNodes, globChart, globParams) {
            return OrgChartV2.prototype.drawNodesInit(orgNodes, globChart, globParams);
        },
        line: function line(parentDOM, lineType, lineParams) {
            return OrgChartV2.prototype.drawLine(parentDOM, lineType, lineParams);
        },
        getPx: function getPx(px) {
            return OrgChartV2.prototype.drawLineGetPx(px);
        }
    },
    drawNodesInit: function drawNodesInit(orgNodes, globChart, globParams, globEvent) {
        var ret = false;
    ...
    drawLine: function drawLine(parentDOM, lineType, lineParams) {
        var ret = {
            id: "",
            instance: null,
            top: "",
        ...
        if ((typeof lineParams === "undefined" ? "undefined" : _typeof(lineParams)) === "object" && lineParams !== null) {
            ...
            parentDOM = (typeof parentDOM === "undefined" ? "undefined" : _typeof(parentDOM)) === "object" && parentDOM !== null ? parentDOM : document.body;
            parentDOM.appendChild(ret.instance);
        }

        return ret;
    },
    drawLineGetPx: function drawLineGetPx(px) {
