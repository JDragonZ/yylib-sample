...
PasteImageUtils.uploadImg = function () {
    var options = arguments.length <= 0 || arguments[0] === undefined ? { url: url, imgData: imgData, params: params, success: success, error: error } : arguments[0];
    ...
    ////发送请求
    //xhr.send(fd);
    var data = _.assign({}, opts.params, { content: opts.imgData.replace('data:image/png;base64,', '') });
